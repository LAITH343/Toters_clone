...
import 'package:toters_clone/screens/Profile/res/logedin.dart';
import 'package:toters_clone/screens/Profile/res/login.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: user_name == "" ? const LoginPage() : const AccountSettingsPage(),
    );
  }
